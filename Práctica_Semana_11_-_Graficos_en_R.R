...
#
# Respuesta 0.2: En airquality hay 153 obervaciones y 6 variables. Además, hay valores faltantes NA
...
#       git clone https://github.com/usuario/XS0129-P11-Apellido1-Apellido2.git
#
